...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.define "client1" do |client1|
        ...
        client1.vm.network "private_network", ip: "10.1.142.201"
        client1.vm.network :forwarded_port, guest: 8200, host: 8202, auto_correct: true
    end

    config.vm.define "client2" do |client2|
        client2.vm.hostname = "client2"
        client2.vm.network "private_network", ip: "10.1.142.202"
        client2.vm.network :forwarded_port, guest: 8200, host: 8202, auto_correct: true
    end
